...
selectionAfter<-function(genos1, genos2, sel1, sel2, sel.comp){
  #Repeat selection vectors to account for B/b genotypes
  sel1 <- rep(c(0,0,0,0,sel1,sel1,sel1,sel1),each=4)
  sel2 <- rep(c(sel2,sel2,sel2,sel2,0,0,0,0),each=4)
  sel.comp <- rep(sel.comp,each=4)
  
  #calculate the fres after selection
  genos1.s.pre <- (1-sel1)*(1-sel.comp)*genos1
  genos2.s.pre <- (1-sel2)*(1-sel.comp)*genos2
  
  #normalize with the sum
  genos1.s <- genos1.s.pre/sum(genos1.s.pre)
  genos2.s <- genos2.s.pre/sum(genos2.s.pre)
...
gametes<-function(geno,r){
  arrayg<-rep(0,4)
  if(geno==1){arrayg<-c(1., 0., 0., 0.,rep(0,4))}
  else if(geno==2){arrayg<-c(0.5, 0.5, 0., 0.,rep(0,4))} 
  else if(geno==3){arrayg<-c(0.5, 0.5, 0., 0.,rep(0,4))} 
  else if(geno==4){arrayg<-c(0., 1., 0., 0.,rep(0,4))} 
  else if(geno==5){arrayg<-c(0.5, 0., 0.5, 0.,rep(0,4))}
  else if(geno==6){arrayg<-c((1 - r)/2, r/2, r/2, (1 - r)/2,rep(0,4))} 
  else if(geno==7){arrayg<-c(r/2, (1 - r)/2, (1 - r)/2, r/2,rep(0,4))} 
  else if(geno==8){arrayg<-c(0., 0.5, 0., 0.5,rep(0,4))} 
  else if(geno==9){arrayg<-c(0.5, 0., 0.5, 0.,rep(0,4))} 
  else if(geno==10){arrayg<-c(r/2, (1 - r)/2, (1 - r)/2, r/2,rep(0,4))} 
  else if(geno==11){arrayg<-c((1 - r)/2, r/2, r/2, (1 - r)/2,rep(0,4))} 
  else if(geno==12){arrayg<-c(0., 0.5, 0., 0.5,rep(0,4))} 
  else if(geno==13){arrayg<-c(0., 0., 1., 0.,rep(0,4))} 
  else if(geno==14){arrayg<-c(0., 0., 0.5, 0.5,rep(0,4))} 
  else if(geno==15){arrayg<-c(0., 0., 0.5, 0.5,rep(0,4))} 
  else if(geno==16){arrayg<-c(0., 0., 0., 1.,rep(0,4))}
  else if(geno==16+1){arrayg<-c(rep(0,4),1., 0., 0., 0.)}
  else if(geno==16+2){arrayg<-c(rep(0,4),0.5, 0.5, 0., 0.)} 
  else if(geno==16+3){arrayg<-c(rep(0,4),0.5, 0.5, 0., 0.)} 
  else if(geno==16+4){arrayg<-c(rep(0,4),0., 1., 0., 0.)} 
  else if(geno==16+5){arrayg<-c(rep(0,4),0.5, 0., 0.5, 0.)}
  else if(geno==16+6){arrayg<-c(rep(0,4),(1 - r)/2, r/2, r/2, (1 - r)/2)} 
  else if(geno==16+7){arrayg<-c(rep(0,4),r/2, (1 - r)/2, (1 - r)/2, r/2)} 
  else if(geno==16+8){arrayg<-c(rep(0,4),0., 0.5, 0., 0.5)} 
  else if(geno==16+9){arrayg<-c(rep(0,4),0.5, 0., 0.5, 0.)} 
  else if(geno==16+10){arrayg<-c(rep(0,4),r/2, (1 - r)/2, (1 - r)/2, r/2)} 
  else if(geno==16+11){arrayg<-c(rep(0,4),(1 - r)/2, r/2, r/2, (1 - r)/2)} 
  else if(geno==16+12){arrayg<-c(rep(0,4),0., 0.5, 0., 0.5)} 
  else if(geno==16+13){arrayg<-c(rep(0,4),0., 0., 1., 0.)} 
  else if(geno==16+14){arrayg<-c(rep(0,4),0., 0., 0.5, 0.5)} 
  else if(geno==16+15){arrayg<-c(rep(0,4),0., 0., 0.5, 0.5)} 
  else if(geno==16+16){arrayg<-c(rep(0,4),0., 0., 0., 1.)}
  return(arrayg)
}
...
matingResult<-function(genos, genof, genom, adv, r){
  ...
  #calculate frequency of mating now also since the adv is repeated I just do this:
  if(genom %in% c(1:4,17:20)) {maleAallele <- 1} 
  else if(genom %in% c(5:8,21:24)){maleAallele <- 2} 
  else if(genom %in% c(9:12,25:28)){maleAallele <- 3}
  else{maleAallele <- 4}
  ...
  arraym <- freqMating*c(gametef[1]*(gametem[1]+gametem[5]), 
                         gametef[1]*(gametem[2]+gametem[6]), 
                         gametef[2]*(gametem[1]+gametem[5]), 
                         gametef[2]*(gametem[2]+gametem[6]), 
                         gametef[1]*(gametem[3]+gametem[7]), 
                         gametef[1]*(gametem[4]+gametem[8]), 
                         gametef[2]*(gametem[3]+gametem[7]), 
                         gametef[2]*(gametem[4]+gametem[8]), 
                         gametef[3]*(gametem[1]+gametem[5]), 
                         gametef[3]*(gametem[2]+gametem[6]), 
                         gametef[4]*(gametem[1]+gametem[5]), 
                         gametef[4]*(gametem[2]+gametem[6]), 
                         gametef[3]*(gametem[3]+gametem[7]), 
                         gametef[3]*(gametem[4]+gametem[8]), 
                         gametef[4]*(gametem[3]+gametem[7]), 
                         gametef[4]*(gametem[4]+gametem[8]),
                         ##now for c
                         gametef[5]*(gametem[1]+gametem[5]), 
                         gametef[5]*(gametem[2]+gametem[6]), 
                         gametef[6]*(gametem[1]+gametem[5]), 
                         gametef[6]*(gametem[2]+gametem[6]), 
                         gametef[5]*(gametem[3]+gametem[7]), 
                         gametef[5]*(gametem[4]+gametem[8]), 
                         gametef[6]*(gametem[3]+gametem[7]), 
                         gametef[6]*(gametem[4]+gametem[8]), 
                         gametef[7]*(gametem[1]+gametem[5]), 
                         gametef[7]*(gametem[2]+gametem[6]), 
                         gametef[8]*(gametem[1]+gametem[5]), 
                         gametef[8]*(gametem[2]+gametem[6]), 
                         gametef[7]*(gametem[3]+gametem[7]), 
                         gametef[7]*(gametem[4]+gametem[8]), 
                         gametef[8]*(gametem[3]+gametem[7]), 
                         gametef[8]*(gametem[4]+gametem[8])
  );
  return(arraym)
}
...
matingAfter<-function(genos1, genos2, d1, d2, r, model, cost){
  ...
  #create sum functions that sum the frequencies over the genos taking into account d1, d2, and cost
  ...
  if(model == 1){
    adv1 <- rep(c((1 + d1)*(1 - cost)/sumM1(genos1), 
                  (1 + d2)*(1 - cost)/sumM1(genos1), 
                  1*(1 - cost)/sumM1(genos1), 
                  1*(1 - cost)/sumM1(genos1)),2)
    adv2 <- rep(c((1 + d1)*(1 - cost)/sumM1(genos2),
                  (1 + d2)*(1 - cost)/sumM1(genos2), 
                  1*(1 - cost)/sumM1(genos2), 
                  1*(1 - cost)/sumM1(genos2)),2)
  }
  else{
    adv1 <- rep(c(1*(1 - cost)/sumM2(genos1), 
                  (1 + d2)*(1 - cost)/sumM2(genos1), 
                  1*(1 - cost)/sumM2(genos1), 
                  (1 + d1)*(1 - cost)/sumM2(genos1)),2)
    adv2 <- rep(c(1*(1 - cost)/sumM2(genos2), 
                  (1 + d2)*(1 - cost)/sumM2(genos2), 
                  1*(1 - cost)/sumM2(genos2), 
                  (1 + d1)*(1 - cost)/sumM2(genos2)),2)
  }
...
after<-function(m12, m21, sel1, sel2, sel.comp, cost, d1, d2, r, b,model,background,N){
  ...
  b.non <- rep(c(0,0,0,1),8)
  
  if(background == 1){ 
    genos1.eq <- pop1.eq * b.intros
    genos2.eq <- pop2.eq * b.non
  }
  else{
    genos1.eq <- pop1.eq * b.non
  ...
  return(c(m12,m21,d1,cost,
           sel1,sel2,
           sel.comp[1],sel.comp[2],sel.comp[3],sel.comp[4],
...
coreAfter <- function(i){
  ...
  sim.r <- i[10]
  sim.cost <- i[11]
  result.after <- after(sim.m12,sim.m21,sim.sel1, sim.sel2, sim.sel.comp, sim.cost,sim.d,0,sim.r,0.01,1,1,100)
  return(result.after)
}

#create all possible combinations of params (in this model there are 11!)
seq.m12 <- seq(0.0,0.12,0.03)
seq.m21 <- seq(0.0,0.12,0.03)
seq.sel1 <- seq(0.0,1.0,0.2)
seq.sel2 <- seq(0.0,1.0,0.2)
seq.sel.comp1 <- seq(0.0,1.0,0.2)
seq.sel.comp2 <- seq(0.0,1.0,0.2)
seq.sel.comp3 <- seq(0.0,1.0,0.2)
seq.sel.comp4 <- seq(0.0,1.0,0.2)
seq.d <- seq(1.0,1.0,0.0)
seq.r <- seq(0.05,0.05,0.0)
seq.cost <- seq(0.0,0.3,0.02)
...
results <- mclapply(sim.list, coreAfter, mc.cores = 90)
...
write.table(results.df, file = "Asymmetric_cytoplasmic_12_5.txt", sep = "\t",
            row.names = FALSE)
